...
export class MessageIO extends EventEmitter {
  reader: MessageIOReader | null = null;
  writer: MessageIOWriter | null = null;
...
export class MessageIOReader extends AbstractMessageReader
...
const CRLF = "\r\n";
export class MessageIOWriter extends AbstractMessageWriter
